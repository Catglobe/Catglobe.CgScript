...
const cgscriptBaseTheme = EditorView.baseTheme({
   ...
   "&light .cm-activeLine":          { backgroundColor: "#d0e4ff99" },
   "&dark  .cm-activeLine":          { backgroundColor: "#ffffff18" },
   "&light .cm-activeLineGutter":    { backgroundColor: "#d0e4ff" },
   "&dark  .cm-activeLineGutter":    { backgroundColor: "#ffffff18" },
