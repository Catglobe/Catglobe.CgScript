...
}, __publicField(_a2, "passThroughHooks", /* @__PURE__ */ new Set([
  "preprocess",
  "postprocess",
  "processAllTokens"
])), _a2);
...
var Workspace = class {
  ...
  */
  updateFile(uri, update) {
    ...
    if (file)
      (_a3 = file.getView()) === null || _a3 === void 0 ? void 0 : _a3.dispatch(update);
  }
  /**
...
var DefaultWorkspace = class extends Workspace {
  ...
  nextFileVersion(uri) {
    var _a3;
    return this.fileVersions[uri] = ((_a3 = this.fileVersions[uri]) !== null && _a3 !== void 0 ? _a3 : -1) + 1;
  }
  syncFiles() {
    let result = [];
    for (let file of this.files) {
...
var LSPClient = class {
  ...
  */
  constructor(config2 = {}) {
    ...
    this.timeout = (_a3 = config2.timeout) !== null && _a3 !== void 0 ? _a3 : 3e3;
  ...
  */
  connect(transport) {
    ...
    this.requestInner("initialize", {
      ...
      this.supportSync = sync == null ? 0 : typeof sync == "number" ? sync : (_a3 = sync.change) !== null && _a3 !== void 0 ? _a3 : 0;
  ...
  */
  ...
  receiveMessage(msg) {
    ...
    if ("id" in value && !("method" in value)) {
      ...
      let handler = (_a3 = this.config.notificationHandlers) === null || _a3 === void 0 ? void 0 : _a3[value.method];
...
function prefixRegexp(items) {
  ...
  for (let i = 0; i < items.length; i += step) {
    let item = items[i], text = ((_a3 = item.textEdit) === null || _a3 === void 0 ? void 0 : _a3.newText) || item.textEditText || item.insertText || item.label;
    if (!/^\w/.test(text)) {
...
var serverCompletionSource = (context2) => {
  ...
  if (!context2.explicit) {
    ...
    let triggers = (_b = (_a3 = plugin.client.serverCapabilities) === null || _a3 === void 0 ? void 0 : _a3.completionProvider) === null || _b === void 0 ? void 0 : _b.triggerCharacters;
  ...
  return getCompletions(plugin, context2.pos, {
    ...
    let defaultCommitChars = (_a4 = result.itemDefaults) === null || _a4 === void 0 ? void 0 : _a4.commitCharacters;
    ...
    return {
      ...
      options: result.items.map((item) => {
        var _a5;
        let text = ((_a5 = item.textEdit) === null || _a5 === void 0 ? void 0 : _a5.newText) || item.textEditText || item.insertText || item.label;
        let option = {
          label: text,
        ...
        if (item.insertTextFormat == 2) {
          option.apply = (view, c, from2, to2) => snippet(text.replace(/\$(\d+)/g, "${$1}"))(view, c, from2, to2);
...
function completionResultRange(cx, result) {
  ...
  let defaultRange = (_a3 = result.itemDefaults) === null || _a3 === void 0 ? void 0 : _a3.editRange, item0 = result.items[0];
...
var signaturePlugin = /* @__PURE__ */ ViewPlugin.fromClass(class {
  ...
  update(update) {
    ...
    if (update.docChanged && update.transactions.some((tr) => tr.isUserEvent("input.type"))) {
      const serverConf = (_a3 = plugin.client.serverCapabilities) === null || _a3 === void 0 ? void 0 : _a3.signatureHelpProvider;
  ...
  startRequest(plugin, context2) {
    ...
    getSignatureHelp(plugin, pos, context2).then((result) => {
      ...
      if (result && result.signatures.length) {
        ...
        let active = same && context2.triggerKind == 3 ? cur2.active : (_a3 = result.activeSignature) !== null && _a3 !== void 0 ? _a3 : 0;
...
function sameActiveParam(a, b, active) {
  var _a3, _b;
  return ((_a3 = a.signatures[active].activeParameter) !== null && _a3 !== void 0 ? _a3 : a.activeParameter) == ((_b = b.signatures[active].activeParameter) !== null && _b !== void 0 ? _b : b.activeParameter);
}
...
function drawSignatureTooltip(view, data, active) {
  ...
  let activeN = (_a3 = signature.activeParameter) !== null && _a3 !== void 0 ? _a3 : data.activeParameter;
      ...
      "textDocument/publishDiagnostics": (client, params) => {
        ...
        view.dispatch(setDiagnostics(view.state, params.diagnostics.map((item) => {
          ...
          return {
            ...
            severity: toSeverity((_a3 = item.severity) !== null && _a3 !== void 0 ? _a3 : 1),
...
function createCgScriptLanguage() {
  const blockkw = new Set("catch else for if try while function switch case".split(" "));
  const keywords = /* @__PURE__ */ new Set([..."break continue return where new throw".split(" "), ...blockkw]);
  const types2 = new Set("object bool number string array question".split(" "));
  const atoms = /* @__PURE__ */ new Set(["true", "false"]);
  const nulls = /* @__PURE__ */ new Set(["empty"]);
  const keywordCompletions = [
    ...[...keywords].map((w) => ({ label: w, type: "keyword" })),
    ...[...types2].map((w) => ({ label: w, type: "keyword" })),
  ...
  function tokenBase(stream, state) {
    ...
    if (keywords.has(cur2)) {
      if (blockkw.has(cur2)) state.curPunc = "newstatement";
      return "keyword";
    }
    if (types2.has(cur2)) return "cgType";
    if (nulls.has(cur2)) return "cgNull";
    if (atoms.has(cur2)) return "cgAtom";
    return "variable";
  }
  ...
  function popContext(state) {
    ...
    if (t2 === ")" || t2 === "]" || t2 === "}") state.indented = state.context.indented;
  ...
  const cgscriptParser = {
    ...
    token(stream, state) {
      ...
      if ((p === ";" || p === ":" || p === ",") && state.context?.type === "statement") {
        ...
        popContext(state);
      } else if (state.context && (state.context.type === "}" || state.context.type === "top") && p !== ";" || state.context?.type === "statement" && p === "newstatement") {
    ...
    indent(state, textAfter) {
      ...
      if (!ctx) return 0;
      const closing2 = first === ctx.type;
      const unit = 4;
      if (ctx.type === "statement") return ctx.indented + (first === "{" ? 0 : unit);
      else if (ctx.align) return ctx.column + (closing2 ? 0 : 1);
      else if (ctx.type === ")" && !closing2) return ctx.indented + unit;
      else return ctx.indented + (closing2 ? 0 : unit);
    },
    languageData: {
  ...
  const language2 = StreamLanguage.define(cgscriptParser);
  return { language: language2, keywordCompletions };
}
async function openTransport(uri) {
  ...
  sock.onmessage = (e) => {
    ...
    try {
      ...
      if (typeof id === "string" && id.startsWith("sem-")) return;
    } catch {
    }
  ...
  return new Promise((resolve, reject) => {
    sock.onopen = () => resolve({
      rawTransport: {
        ...
        unsubscribe(h) {
          rawHandlers = rawHandlers.filter((x) => x !== h);
        }
      },
      lspTransport: {
        send: sendMsg,
        ...
        unsubscribe(h) {
          lspHandlers = lspHandlers.filter((x) => x !== h);
        }
      },
      closed
    });
...
var setSemanticDecos = StateEffect.define();
var semanticDecoField = StateField.define({
...
var SEMANTIC_CLASSES = [
  ...
  // 6: function
  "cm-cgs-type",
  // 7: class (object type like Dictionary)
  "cm-cgs-constant",
  // 8: enumMember (constant)
  null,
  // 9: parameter
  "cm-cgs-function",
  // 10: method (same style as function)
  "cm-cgs-property",
  // 11: property
  "cm-cgs-macro"
  // 12: macro (preprocessor directive)
];
var _semReqCounter = 0;
function makeSemanticTokensViewPlugin(transport, fileUri) {
  class SemanticPlugin {
    ...
    _handleMsg(raw) {
      try {
        ...
        const doc2 = this._view.state.doc;
        const decos = [];
        let line = 0, col = 0;
        for (let i = 0; i + 4 < data.length; i += 5) {
          ...
          if (!cls || line + 1 > doc2.lines) continue;
          const lineObj = doc2.line(line + 1);
          const from = lineObj.from + col;
          const to = from + len;
          if (to > doc2.length) continue;
...
var defaultHighlight = HighlightStyle.define([
...
var midnightHighlight = HighlightStyle.define([
...
var defaultSemanticTheme = EditorView.theme({
...
var midnightSemanticTheme = EditorView.theme({
...
var defaultEditorTheme = EditorView.theme({
  "&": { backgroundColor: "white" },
...
var midnightEditorTheme = EditorView.theme({
...
var signatureHintTheme = EditorView.baseTheme({
  ".cm-lsp-signature-num": {
...
function resolveTheme(name2) {
  return THEMES[name2] ?? THEMES["default"];
}
var _view, _themeCompartment, _lspCompartment, _saveDraftTimer;
var CodeMirrorForCgScript = class {
  constructor(parent, initialContent, selectedTheme, opts) {
    __privateAdd(this, _view);
    __privateAdd(this, _themeCompartment, new Compartment());
    __privateAdd(this, _lspCompartment, new Compartment());
    __privateAdd(this, _saveDraftTimer, null);
    const { language: language2, keywordCompletions } = createCgScriptLanguage();
    const saveDelay = opts?.saveDelay ?? 2e3;
    const startState = EditorState.create({
      ...
      extensions: [
        ...
        closeBrackets(),
        autocompletion(),
        language2.data.of({ autocomplete: completeFromList(keywordCompletions) }),
        ...
        language2,
        semanticDecoField,
        __privateGet(this, _themeCompartment).of(resolveTheme(selectedTheme)),
        __privateGet(this, _lspCompartment).of([]),
        ...
        keymap.of([
          ...
          indentWithTab,
          { key: "Ctrl-h", run: () => {
            openSearchPanel(__privateGet(this, _view));
            return true;
          } },
          { key: "F11", run: () => {
        ...
        EditorView.updateListener.of((update) => {
          ...
          if (opts?.onDocChange) {
            if (__privateGet(this, _saveDraftTimer)) clearTimeout(__privateGet(this, _saveDraftTimer));
            __privateSet(this, _saveDraftTimer, setTimeout(() => opts.onDocChange(text), saveDelay));
          }
        }),
    ...
    __privateSet(this, _view, new EditorView({ state: startState, parent }));
  }
  connectLsp(lspClient, transport, fileUri) {
    __privateGet(this, _view).dispatch({
      effects: __privateGet(this, _lspCompartment).reconfigure([
  ...
  disconnectLsp() {
    __privateGet(this, _view).dispatch({ effects: __privateGet(this, _lspCompartment).reconfigure([]) });
  }
  setTheme(name2) {
    __privateGet(this, _view).dispatch({ effects: __privateGet(this, _themeCompartment).reconfigure(resolveTheme(name2)) });
  }
  getSelection() {
    const sel = __privateGet(this, _view).state.selection.main;
    return sel.from === sel.to ? "" : __privateGet(this, _view).state.sliceDoc(sel.from, sel.to);
  }
  loadContent(text) {
    __privateGet(this, _view).dispatch({
      changes: { from: 0, to: __privateGet(this, _view).state.doc.length, insert: text }
    });
  }
  _setFullscreen(on) {
    document.body.classList.toggle("CodeMirror-fullscreen", on);
    __privateGet(this, _view).requestMeasure();
  }
  toggleFullscreen() {
...
_view = new WeakMap();
_themeCompartment = new WeakMap();
_lspCompartment = new WeakMap();
_saveDraftTimer = new WeakMap();
async function manageLspConnection(wsUri, cm, fileUri) {
...
export {
  ...
  LSPClient,
  SEMANTIC_CLASSES,
  createCgScriptLanguage,
  languageServerExtensions,
  makeSemanticTokensViewPlugin,
  manageLspConnection,
  openTransport,
  resolveTheme,
  semanticDecoField,
